...
pub struct FlatTexturePipeline {
...
impl FlatTexturePipeline {
	...
	pub fn new(opts: &GraphicsOpts, device: &wgpu::Device, surface_format: wgpu::TextureFormat, camera_bind_group_layout: &wgpu::BindGroupLayout, lines: bool) -> Self {
